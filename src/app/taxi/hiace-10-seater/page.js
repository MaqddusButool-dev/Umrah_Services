...
const vehicleData = {
  ...
  specifications: [
    ...
    { label: "Luggage Capacity", value: "8 Large Bags" },
  ],
  description: "The Toyota Hiace is perfect for larger groups and families. With comfortable seating for 10 passengers and ample luggage space, it's the ideal choice for group travel during Umrah or Hajj. Known for its reliability and comfort.",
};
