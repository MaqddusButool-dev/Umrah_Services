...
const vehicleData = {
  ...
  description: "The Hyundai Sonata is an economical choice for small groups without compromising comfort. Perfect for couples or small families, offering reliability and modern amenities at an affordable price.",
};

export default function SonataPage() {
  return (
