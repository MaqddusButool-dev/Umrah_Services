...
const vehicleData = {
  ...
  description: "A powerful and stylish option for group travel. The Chevrolet 7 Seater combines comfort, performance, and style to provide an excellent travel experience for your sacred journey.",
};
