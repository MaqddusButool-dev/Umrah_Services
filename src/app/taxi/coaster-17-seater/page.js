...
const vehicleData = {
  ...
  specifications: [
    ...
    { label: "Air Conditioning", value: "Full Bus AC" },
    { label: "Luggage Capacity", value: "12 Large Bags" },
  ],
  description: "The Toyota Coaster is ideal for large groups and tour groups. With seating for 17 passengers and extensive luggage capacity, it ensures everyone travels together comfortably. Perfect for group Umrah or Hajj packages.",
};
